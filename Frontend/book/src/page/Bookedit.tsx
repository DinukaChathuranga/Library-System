            ...
            <div className="col-md-12">
              <div className="block text-center">
                ...
                <ul className="list-inline">
                  ...
                  <li className="list-inline-item"><a href="/edit" className="text-white-50">edit  book</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="row" style={{ display: 'flex', justifyContent: 'center' }}>
            <div className="col-lg-6 col-md-12 col-sm-12">
              <form id="contact-form" className="contact__form" method="post" action="mail.php">
                ...
                <h3 className="text-md mb-4">Edit book</h3>
                ...
                <button className="btn btn-main" name="submit" type="submit">Edit</button>
              </form>
